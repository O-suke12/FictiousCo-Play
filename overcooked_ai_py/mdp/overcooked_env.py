...
from ..utils import append_dictionaries, mean_and_std_err
from ..visualization.state_visualizer import StateVisualizer
from .actions import Action
from .overcooked_mdp import (
    EVENT_TYPES,
    OvercookedGridworld,
)
from .overcooked_trajectory import (
    DEFAULT_TRAJ_KEYS,
)
...
class OvercookedEnvPettingZoo(ParallelEnv):
    def __init__(self, base_env, agents):
        ...
        # assert isinstance(agents, AgentPair), "agents must be an AgentPair object"
    ...
    def step(self, joint_action):
        ...
        def create_obs_dict(obs):
            ...
            """
            return {
                agent: self.agent_map[agent].featurize(obs) for agent in self.agents
            }
